/*
  ...
  - Added the required column `updatedAt` to the `EventItem` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `EventItemsOnResources` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "EventItem" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;

-- AlterTable
ALTER TABLE "EventItemsOnResources" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
